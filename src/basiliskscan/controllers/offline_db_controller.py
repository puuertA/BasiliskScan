"""Controlador do banco offline de vulnerabilidades."""
...
from ..views.terminal_view import UIHelper, normalize_cli_directory_input, validate_target_path


class OfflineDBController:
    """Coordena operações do banco offline."""
    ...
    def execute(
        ...
        try:
            ...
            if normalized_project_path is not None:
                ...
                components = self._build_unique_components(dependencies)
